...
#			time_left_minutes_num = int(((close_next_time_format-present_time_format).seconds%3600)/60)
			time_left_minutes_num = int((close_next_time_format-present_time_format).seconds/60)			
			...
			status_code = 100000
			order_num = status_code - time_left_minutes_num
...
#			time_left_minutes_num = int(((present_time_format-close_next_time_format).seconds%3600)/60)
			time_left_minutes_num = int((present_time_format-close_next_time_format).seconds/60)
